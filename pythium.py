...
# ========================
"""
Pythium Browser - A lightweight web browser built with PyQt5 and QtWebEngine
"""
# ========================
...
class Browser(QMainWindow):
    def __init__(self):
        ...
        global global_vars
        global_vars["User_Agent"] = self.User_Agent
    ...
    def set_config(self):
        ...
        self.config_window.title("Pythium Config")
    ...
    def quit_config(self):
        if self.config_text.get("1.0", tk.END)[:-1] != self.before_content:
            if messagebox.askyesno(
                "Save Changes", "Do you want to save changes before quitting?"
            ):
                self.save_config(self.config_text.get("1.0", tk.END)[:-1])
        self.config_window.destroy()
...
profile.setHttpUserAgent(global_vars["User_Agent"])
